...
set output 'plot_4dgr_log.png'
A(x)=A_0*log(x)+ A_1*log(x)**2 + A_2*log(x)**3 + A_3*log(x)**4 + A_4*log(x)**5#pridat konstantu
A_0 = 1 
A_1 = 1
A_2 = 1
A_3 = 1
...
fit A(x) 'rocnikovka_data.csv' using 1:2 via A_0,A_1, A_2, A_3, A_4
